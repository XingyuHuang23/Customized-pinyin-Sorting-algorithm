...
public class RandomWalkTest {
    ...
    public void testRandomWalk() {
        for (int i = 0; i < 1000; i++)
            assertEquals(10, RandomWalk.randomWalkMulti(100, 100), 0);  //m: random steps in one time, n: total times of experiment

        //the relationship is meanDistance  = sqrt of steps the drunk did.
    }
